...
class TestPlans extends Component {
	constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
    	<div>
		    ...
		    <PageContainer pageName={"Test Plans"}  pageSubName={"View"}/>
	    </div>
    );
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(TestPlans);